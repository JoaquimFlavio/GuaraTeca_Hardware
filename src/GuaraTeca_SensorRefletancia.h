...
#ifndef GuaraTeca_SensorRefletancia_H 
#define GuaraTeca_SensorRefletancia_H 
...
class SensorRefletancia{
    public:
        SensorRefletancia();//construtor da classe SensorRefletancia.
        void iniciaSensorRefletancia(uint8_t pino);//metodo para preparar o hardware para os devidos comandos
        int leitura(uint8_t pino);//metodo para retornar o valor lido pelo sensor.
};
