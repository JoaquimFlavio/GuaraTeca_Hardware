...
#ifndef GuaraTeca_PushButton_H 
#define GuaraTeca_PushButton_H
...
class Botao{
    public:
        Botao();//construtor da classe PonteH
        void iniciaBotao(uint8_t Pin);//metodo para preparar o hardware para os devidos comandos.
        int estado(uint8_t Pin);//metodo para leitura do botao.
};
#endif