...
#ifndef GuaraTeca_SensorAgua_H 
#define GuaraTeca_SensorAgua_H
...
class SensorAgua{
    public:
        SensorAgua();//construtor da classe SensorChuva.
        void iniciaSensorAgua(uint8_t pinoA, uint8_t pinoD = 0);//metodo para preparar o hardware para os devidos comandos
        
        short int leitura(uint8_t pinoA, uint8_t pinoD = 0);//metodo para retornar o valor lido pelo sensor.
};
#endif