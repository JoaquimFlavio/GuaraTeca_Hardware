...
#ifndef GuaraTeca_Sensor_HCSR04_H 
#define GuaraTeca_Sensor_HCSR04_H 
...
class HCSR04{
    public:
        HCSR04();//construtor da classe HCSR04.
        void iniciaHCSR04(uint8_t Tp, uint8_t Ep);//metodo para preparar o hardware para os devidos comandos
