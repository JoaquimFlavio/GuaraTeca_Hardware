...
#ifndef GuaraTeca_Sensor_TCS230_H 
#define GuaraTeca_Sensor_TCS230_H 
...
class TCS230{    
    public:
        TCS230();//construtor da classe TCS230.
        void iniciaTCS230(uint8_t out, uint8_t S0, uint8_t S1, uint8_t S2, uint8_t S3);//metodo para preparar o hardware para os devidos comandos
